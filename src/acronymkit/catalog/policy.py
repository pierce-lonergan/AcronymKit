...
-------------------------------------------------------
A policy is a dict key. :meth:`~acronymkit.catalog.dictionary.GovernedDictionary._memo`
...
:mod:`acronymkit.catalog.models` for the rest of that argument, which is the
same argument.
...
class NamingPolicy:
    ...
    def model_copy(
        ...
        *,
        ...
        :meth:`acronymkit.catalog.models._FrozenModel.model_copy`, and the same
