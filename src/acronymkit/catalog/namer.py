...
version forgot to do — see :func:`~acronymkit.catalog.loaders.load_bundle`. And
...
resolved, and :class:`~acronymkit.catalog.dictionary.GovernedDictionary`
...
class GovernedNamer:
    ...
    :class:`~acronymkit.catalog.dictionary.GovernedDictionary` sets out.
    ...
    def __init__(
        ...
        *,
        ...
        :func:`~acronymkit.catalog.expansion.expand_token` performs per call
        ...
        Args:
            ...
            policy: The rules to apply to every call. ``None`` means
                :meth:`~acronymkit.catalog.policy.NamingPolicy.governed_default`,
    ...
    def from_bundle(
        ...
        *,
        ...
        :func:`~acronymkit.catalog.loaders.load_bundle`'s and are documented
        there.
        ...
        Args:
            ...
            term_columns: As :func:`~acronymkit.catalog.loaders.load_bundle`.
            encoding: As :func:`~acronymkit.catalog.loaders.load_bundle`.

        Returns:
            The namer.

        Raises:
            LexiconError: As :func:`~acronymkit.catalog.loaders.load_bundle`.
        """
        return cls(
    ...
    def from_csv(
        ...
        *,
        ...
        Every argument but ``policy`` is :func:`~acronymkit.catalog.loaders.load_csv`'s
        ...
        Args:
            path: The CSV file.
            policy: As :meth:`__init__`.
            token_column: As :func:`~acronymkit.catalog.loaders.load_csv`.
            canonical_column: As :func:`~acronymkit.catalog.loaders.load_csv`.
            encoding: As :func:`~acronymkit.catalog.loaders.load_csv`.
            delimiter: As :func:`~acronymkit.catalog.loaders.load_csv`.
            custom: As :meth:`__init__`.
        ...
        Raises:
            LexiconError: As :func:`~acronymkit.catalog.loaders.load_csv`.
        """
        return cls(
            load_csv(
                path,
    ...
    def from_long_to_short_csv(
        ...
        *,
        ...
        but ``policy`` is
        :func:`~acronymkit.catalog.loaders.load_long_to_short_csv`'s, including
        what the inversion does to a collision and how it records it.

        Args:
            path: The CSV file.
            policy: As :meth:`__init__`.
            long_column: As :func:`~acronymkit.catalog.loaders.load_long_to_short_csv`.
            short_column: As :func:`~acronymkit.catalog.loaders.load_long_to_short_csv`.
            encoding: As :func:`~acronymkit.catalog.loaders.load_long_to_short_csv`.
            delimiter: As :func:`~acronymkit.catalog.loaders.load_long_to_short_csv`.
            custom: As :meth:`__init__`.
            approved_abbreviations: As :meth:`GovernedDictionary.__init__`.
            common_keywords: As :meth:`GovernedDictionary.__init__`.
            short_full_words: As :meth:`GovernedDictionary.__init__`.
        ...
        Raises:
            LexiconError: As :func:`~acronymkit.catalog.loaders.load_long_to_short_csv`.
        """
        return cls(
    ...
    def expand_token(self, token: Optional[str]) -> TokenExpansion:
        """Expand one token. See :func:`~acronymkit.catalog.expansion.expand_token`.
    ...
    def expand_identifier(self, identifier: Optional[str]) -> IdentifierExpansion:
        """Expand a whole identifier. See :func:`~acronymkit.catalog.expansion.expand_identifier`.
    ...
    def to_physical_name(self, logical: str) -> PhysicalName:
        """Render a logical name. See :func:`~acronymkit.catalog.naming.to_physical_name`.
    ...
    def is_compliant(self, name: str) -> ComplianceResult:
        """Check a physical name. See :func:`~acronymkit.catalog.compliance.is_compliant`.
    ...
    def normalize(self, name: str) -> str:
        """Correct a physical name. See :func:`~acronymkit.catalog.compliance.normalize`.
    ...
    def expand_many(self, identifiers: Iterable[Optional[str]]) -> tuple[IdentifierExpansion, ...]:
        ...
        * **Per-item independence.** Nothing is carried from one item to the
        ...
        Returns:
            One :class:`~acronymkit.catalog.models.IdentifierExpansion` per
    ...
    def check_many(self, names: Iterable[str]) -> tuple[ComplianceResult, ...]:
        ...
        Returns:
            One :class:`~acronymkit.catalog.models.ComplianceResult` per input,
            in input order.
        """
        catalog, policy = self._dictionary, self._policy
