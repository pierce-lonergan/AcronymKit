"""Compatibility path for :mod:`acronymkit.catalog.loaders`.

This module object **is** :mod:`acronymkit.catalog.loaders`. It does not import
...
this name after execution. So ``acronymkit.governed.loaders is
acronymkit.catalog.loaders`` is ``True``, every private helper is reachable
...
from ..catalog import loaders as _module
