"""Compatibility path for :mod:`acronymkit.catalog.scoring`.

This module object **is** :mod:`acronymkit.catalog.scoring`. It does not import
...
this name after execution. So ``acronymkit.governed.scoring is
acronymkit.catalog.scoring`` is ``True``, every private helper is reachable
...
from ..catalog import scoring as _module
