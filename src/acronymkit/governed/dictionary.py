"""Compatibility path for :mod:`acronymkit.catalog.dictionary`.

This module object **is** :mod:`acronymkit.catalog.dictionary`. It does not import
...
this name after execution. So ``acronymkit.governed.dictionary is
acronymkit.catalog.dictionary`` is ``True``, every private helper is reachable
...
from ..catalog import dictionary as _module
