"""Compatibility path for :mod:`acronymkit.catalog.audit`.

This module object **is** :mod:`acronymkit.catalog.audit`. It does not import
...
this name after execution. So ``acronymkit.governed.audit is
acronymkit.catalog.audit`` is ``True``, every private helper is reachable
...
from ..catalog import audit as _module
