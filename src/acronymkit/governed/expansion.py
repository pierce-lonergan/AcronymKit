"""Compatibility path for :mod:`acronymkit.catalog.expansion`.

This module object **is** :mod:`acronymkit.catalog.expansion`. It does not import
...
this name after execution. So ``acronymkit.governed.expansion is
acronymkit.catalog.expansion`` is ``True``, every private helper is reachable
...
from ..catalog import expansion as _module
