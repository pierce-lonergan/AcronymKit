"""Compatibility path for :mod:`acronymkit.catalog.tokenizer`.

This module object **is** :mod:`acronymkit.catalog.tokenizer`. It does not import
...
this name after execution. So ``acronymkit.governed.tokenizer is
acronymkit.catalog.tokenizer`` is ``True``, every private helper is reachable
...
from ..catalog import tokenizer as _module
