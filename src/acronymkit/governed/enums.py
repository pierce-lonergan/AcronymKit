"""Compatibility path for :mod:`acronymkit.catalog.enums`.

This module object **is** :mod:`acronymkit.catalog.enums`. It does not import
...
this name after execution. So ``acronymkit.governed.enums is
acronymkit.catalog.enums`` is ``True``, every private helper is reachable
...
from ..catalog import enums as _module
