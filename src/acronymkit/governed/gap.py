...
:mod:`~acronymkit.governed.audit` answers *what does this vocabulary do to my
...
---------------------------------------------------------------------------------
With no catalog, :func:`~acronymkit.governed.expansion.expand_token` falls
...
class GapToken(_FrozenModel):
    ...
    :class:`~acronymkit.governed.audit.UnknownToken`. That class ranks what a
...
def _require(dictionary: Optional[GovernedDictionary]) -> None:
    ...
    :func:`~acronymkit.governed.expansion.expand_identifier`, where a governed
    ...
    *,
    ...
    Args:
        ...
        custom: A per-call overlay, passed straight through to
            :func:`~acronymkit.governed.expansion.expand_token`.
    ...
    Raises:
        ConfigurationError: If ``dictionary`` is neither a
            :class:`~acronymkit.governed.dictionary.GovernedDictionary` nor
