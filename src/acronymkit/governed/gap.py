"""Compatibility path for :mod:`acronymkit.catalog.gap`.

This module object **is** :mod:`acronymkit.catalog.gap`. It does not import
...
this name after execution. So ``acronymkit.governed.gap is
acronymkit.catalog.gap`` is ``True``, every private helper is reachable
...
from ..catalog import gap as _module
