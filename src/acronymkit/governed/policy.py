"""Compatibility path for :mod:`acronymkit.catalog.policy`.

This module object **is** :mod:`acronymkit.catalog.policy`. It does not import
...
this name after execution. So ``acronymkit.governed.policy is
acronymkit.catalog.policy`` is ``True``, every private helper is reachable
...
from ..catalog import policy as _module
