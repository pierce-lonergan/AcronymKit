"""Compatibility path for :mod:`acronymkit.catalog.compliance`.

This module object **is** :mod:`acronymkit.catalog.compliance`. It does not import
...
this name after execution. So ``acronymkit.governed.compliance is
acronymkit.catalog.compliance`` is ``True``, every private helper is reachable
...
from ..catalog import compliance as _module
