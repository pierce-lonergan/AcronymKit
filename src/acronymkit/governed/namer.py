"""Compatibility path for :mod:`acronymkit.catalog.namer`.

This module object **is** :mod:`acronymkit.catalog.namer`. It does not import
...
this name after execution. So ``acronymkit.governed.namer is
acronymkit.catalog.namer`` is ``True``, every private helper is reachable
...
from ..catalog import namer as _module
