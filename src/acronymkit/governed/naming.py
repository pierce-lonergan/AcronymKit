"""Compatibility path for :mod:`acronymkit.catalog.naming`.

This module object **is** :mod:`acronymkit.catalog.naming`. It does not import
...
this name after execution. So ``acronymkit.governed.naming is
acronymkit.catalog.naming`` is ``True``, every private helper is reachable
...
from ..catalog import naming as _module
