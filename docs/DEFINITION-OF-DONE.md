...
`0.4.0`** and that the release notes disclose one of the two. Criterion `9` records `21` of `42`
unchanged, and `docs/GATES.md:28`'s *"forty-one gates"* against a manifest of `42` **fixed at the
release commit** along with the self-contradiction two screens below it. Criterion
